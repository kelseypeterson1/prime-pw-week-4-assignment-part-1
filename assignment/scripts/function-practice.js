...
console.log('Test - should say "Hello Liz!"', helloName('Liz!'));
...
console.log('Test - should add 10 & 12', addNumbers(10,12));

// 4. Function to multiply three numbers & return the result
function multiplyThree(firstNumber, secondNumber, thirdNumber){
  return firstNumber * secondNumber * thirdNumber
}
console.log('Test - should multiply 2, 3 & 4', multiplyThree(2,3,4));
